...
local Window = OrionLib:MakeWindow({Name = "x2seed hub", HidePremium = false, IntroText = "️x2seed hub", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("ผู้พัฒนา")
W:AddLabel("x2seed hub SCRIPT")
W:AddLabel("Discord x2seed hub")
local Section = W:AddSection({
    Name = "Status"
})
